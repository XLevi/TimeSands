...
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mShapeMode = a.getInt(R.styleable.RoundImageView_mode, 0);
            mRadius = a.getDimension(R.styleable.RoundImageView_radius, 0);

            mStrokeWidth = a.getDimension(R.styleable.RoundImageView_strokeWidth, 0);
            mStrokeColor = a.getColor(R.styleable.RoundImageView_strokeColor, mStrokeColor);
            a.recycle();
        }
...
//            }
    ...
    private void makeStrokeBitmap() {
        Log.d("RoundImage", "makeStrokeBitmap");
